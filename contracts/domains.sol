...
contract Domains is ERC721URIStorage{
  ...
  constructor(string memory _tld) ERC721 ("BRUH Name Service", "BRUH") payable {
    console.log("Taking %s for domain",_tld);
    ...
    bytes(
      string(
        abi.encodePacked(
          '{"name": "',
          _name,
          '", "description": "A domain on the Bruh name service", "image": "data:image/svg+xml;base64,',
